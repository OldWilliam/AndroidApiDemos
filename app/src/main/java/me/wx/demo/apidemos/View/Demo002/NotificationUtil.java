...
import me.wx.demo.apidemos.MainActivity;
...
public class NotificationUtil {
    ...
    public void showNotification(int notificationId) {
        ...
        if (!map.containsKey(notificationId)) {
            ...
            // 设置通知显示的图标
            notification.icon = R.drawable.shadow;
            // 设置通知的特性: 通知被点击后，自动消失
    ...
    public void updateProgress(final int notificationId, final int progress) {
        final Notification notify = map.get(notificationId);
//        if (null != notify) {
//            // 修改进度条
